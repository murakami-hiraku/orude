...
<main class="page-blog fadein">
  <div class="page-blog__wrap">
    <div class="page-blog__inner">
      ...
      $posts_per_page = $is_mobile ? 12 : 12;
      ...
      <section class="page-blog__contents">
              ...
              <article class="page-blog__card">
                <a href="<?php the_permalink(); ?>">
                  ...
                  <div class="page-blog__card-body">
                    <time class="page-blog__card-date"><?php echo get_the_date('Y.m.d'); ?></time>
          ...
          ?>
            <div class="page-blog__pagination">
              ...
              <div class="page-blog__pagination-squares">
                <?php
                // ページネーション表示数（スマホは5、PCは6）
                $visible_count = $is_mobile ? 5 : 6;
