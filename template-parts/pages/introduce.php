              ...
              <div class="page-introduce__cards">
                ...
                <div class="page-introduce__card card-3">
                  ...
                  <div class="page-introduce__card-txt">
                    ...
                    <h4>03　保冷の準備</h4>
                    <p>お身体が傷まないよう保冷剤やドライアイスをご使用ください。<br>お腹や頭を中心にしっかり冷やしてあげることで、<br>ゆっくりとお別れの時間を過ごせます。
                      <br><br>
                ...
                <div class="page-introduce__card card-4">
                  ...
                  <div class="page-introduce__card-txt">
                    ...
                    <p>慣れ親しんだベット等に寝かせてあげた後<br>上からそっとタオルをかけてあげてください。<br>お花、大好きだったおやつなどを添える方もいらっしゃいます。
                      <br><br>
                      この時間は、かけがえのないご家族と過ごす、最後の静かな時間です。<br>たくさんの「ありがとう」を、どうか、その子に伝えてあげてください。
                    </p>
                    <!-- <span>✧ご家族様が揃うまでの時間も、大切にお使いいただけます。</span> -->
                  </div>
                </div>
              </div>
            </div>
