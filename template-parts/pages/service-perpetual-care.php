  ...
  <main class="page-s-perpetual-care">
      ...
      <div class="page-s-perpetual-care__inner inner">
        ...
        <div class="page-s-perpetual-care__container">
          <div class="page-s-perpetual-care__box">
            ...
            <p class="page-s-perpetual-care__txt">共に人生を歩んできた最愛のペットと天国でも一緒にいたいという想いは、人もペットも同じです。
              近年、このように人とペットが同じお墓で眠れる永代供養へのニーズが高まっており、それに応える霊園やサービスも増えてきています</p>
          </div>
        </div>
      </div>
    ...
    <section class="page-s-perpetual-care__section page-s-perpetual-care__section--2 section fadein ">
      <div class="page-s-perpetual-care__inner inner">
        <h2 class="page-s-perpetual-care__ttl">人とペットが
          永遠に寄り添える供養の場をご提供</h2>
        <p class="page-s-perpetual-care__txt">安心できる環境で永代納骨を行い、ご家族様に寄り添うことをお約束します。
          大切なペットも人と同じように心を込めて供養させていただきます</p>
    ...
    <section class="page-s-perpetual-care__section page-s-perpetual-care__section--3 section fadein ">
      <div class="page-s-perpetual-care__inner inner">
        ...
        <p class="page-s-perpetual-care__txt">銀山寺（ぎんざんじ）は大阪市天王寺区・四天王寺のほど近くに位置する浄土宗の古刹です。創建は安土桃山時代の1591年（天正19年）、豊臣秀吉の大坂城下町整備の一環として建立され、当初は「大福寺」と称しましたが、後に太閤秀吉の命により「寶樹山 銀山寺」と改められました。開山（創始者）は京都・黒谷の金戒光明寺の僧で、以来430年以上の歴史を紡いできた由緒ある寺院です。大阪市内中心部の上町台地に位置し交通の便がよいお寺で、地下鉄谷町線・千日前線「谷町九丁目」駅から徒歩約10分とアクセス至便です。寺町の一角に佇む重厚な本堂は歴史の重みを感じさせ、境内には著名人や学者の墓所も祀られています。
        ...
        <div class="page-s-perpetual-care__cards">
          <div class="page-s-perpetual-care__card">
            ...
            <div class="page-s-perpetual-care__card-body">
              ...
              <p class="page-s-perpetual-care__card-txt">まずはお電話やホームページのお問い合わせフォームにてご連絡ください。
                専任スタッフがサービス内容や費用の目安などについて丁寧にご説明いたします。
                疑問点や不安な点は何でもご相談ください。
                生前のお申し込みについてのご相談も承っております。</p>
            </div>
          </div>
          <div class="page-s-perpetual-care__card">
            <div class="page-s-perpetual-care__card-img">
            ...
            <div class="page-s-perpetual-care__card-body">
              ...
              <p class="page-s-perpetual-care__card-txt">銀山寺にご来訪いただき、境内や永代納骨墓『ともに』をご見学いただけます。
                歴史ある寺院の雰囲気や納骨墓の佇まいをご確認ください。
                十分ご納得いただけましたら、所定の申込書にてお申し込み手続きを行います。
                ご契約時に、将来一緒に安置したいペットやご家族についてもご相談ください。</p>
            </div>
          </div>
          <div class="page-s-perpetual-care__card">
            <div class="page-s-perpetual-care__card-img">
            ...
            <div class="page-s-perpetual-care__card-body">
              ...
              <p class="page-s-perpetual-care__card-txt">お申し込み後、実際にご納骨される際の日程や流れについて打ち合わせを行います。
                また、納骨式当日の法要の内容（読経やお焼香など）について、ご希望があればお伝えください。</p>
            </div>
          </div>
          <div class="page-s-perpetual-care__card">
            <div class="page-s-perpetual-care__card-img">
            ...
            <div class="page-s-perpetual-care__card-body">
              ...
              <p class="page-s-perpetual-care__card-txt">銀山寺境内にて納骨式を執り行います。
                当日はご家族立会いのもと、ご遺骨を永代供養納骨墓の人用区画または
                ペット用区画へそれぞれ安置します。銀山寺の住職が読経し、
                故人とペットの冥福を共に祈る法要を営みます。
                魂が安らかに鎮まるよう、心を込めて儀式を進めさせていただきます。
                塔婆の建立やプレート（オプション）の設置なども行い、永代納骨への納骨が完了します。</p>
            </div>
          </div>
          <div class="page-s-perpetual-care__card">
            <div class="page-s-perpetual-care__card-img">
            ...
            <div class="page-s-perpetual-care__card-body">
              ...
              <p class="page-s-perpetual-care__card-txt">納骨墓は毎日朝7時30分から夕方17時まで開放されており、ご
                都合の良いときにいつでもお参りいただけます。
                ご遺骨は銀山寺が責任を持ってお守りしますので、
                将来的にお墓の継承者がいなくなってもご安心ください。</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="page-s-perpetual-care__section page-s-perpetual-care__section--2 section fadein ">
      <div class="page-s-perpetual-care__inner inner">
        ...
        <p class="page-s-perpetual-care__txt">ご利用料金は供養形態や収蔵人数（ペットの頭数）によって異なりますが、
          主なプランの価格目安は以下の通りです（すべて永代供養料込み・税込みの金額です）。</p>
        ...
        <div class="page-s-perpetual-care__card">
          ...
          <div class="page-s-perpetual-care__card-body">
            ...
            <p class="page-s-perpetual-care__card-txt">複数のご遺骨を合同で納骨墓に収蔵するプランです。
              他の形式に比べ費用を抑えられるのが特徴です。
              経済的負担を軽減しつつ、永代にわたり手厚い供養を受けられます。</p>
          </div>
        </div>
    ...
    <section class="page-s-perpetual-care__section page-s-perpetual-care__section--2 section fadein ">
      <div class="page-s-perpetual-care__inner inner">
        ...
        <p class="page-s-perpetual-care__txt">オルデでは、銀山寺での永代納骨を中心にご案内しておりますが、ご家族様のご事情やご希望に応じて、その他の霊園・寺院のご紹介も可能です。
          ・立地やアクセスを重視したい方・ご自宅から通いやすい場所を選びたい方・ 静かな環境や雰囲気を大切にしたい方・ 宗教・宗派や供養形式についてご希望がある方
