...
<main class="page-s-cremation">
  ...
  <section class="page-s-cremation__section page-s-cremation__section--1 section fadein">
    ...
    <div class="page-s-cremation__inner inner">
      ...
      <p class="page-s-cremation__txt">
        オルデの訪問火葬は、ご自宅またはご指定の場所まで専用車でお伺いし、火葬のみを執り行うサービスです。<br>葬儀や自宅葬は行わず、「静かに、丁寧に火葬をしてほい」「形式よりも負担を少なくしたい」というご家族様のためのプランです。<br>移動のご負担もなく、お迎えに上がるまでゆっくりと最期の時間をお過ごしいただけます。
      </p>
    </div>
      ...
      <div class="page-s-cremation__cards">
        ...
        <div class="page-s-cremation__card">
          ...
          <p class="page-s-cremation__card-txt">
            火葬炉を搭載した車両には、社名やロゴなどの表記は一切ありません。一見すると一般的なバンタイプの車両のため、ご近所に配慮しながらご利用いただけます。マンションや住宅街でも安心してご相談ください。</p>
        ...
        <div class="page-s-cremation__card">
          ...
          <p class="page-s-cremation__card-txt">
            臭い・煙・音を最小限に抑えた最新式の火葬炉を使用しています。<br>各自治体の条例に基づいた正式な許可を受けた設備を使用し、風向きや周囲の状況を確認したうえで安全に火葬を行います。</p>
        ...
        <div class="page-s-cremation__card card--4">
          ...
          <div class="page-s-cremation__card-body">
            ...
            <a class="page-s-cremation__link ceremony" href="<?php echo home_url('/service-ceremony'); ?>">
              ...
              <p class="link-txt">自宅葬プランの詳細はこちら</p><span class="icon-arrow"></span>
            </a>
      ...
      <div class="page-s-cremation__cards">
        ...
        <div class="page-s-cremation__card card--3">
          ...
          <div class="page-s-cremation__card-body">
            ...
            <p class="page-s-cremation__card-txt">
              近隣の安全な場所に移動して火葬を執り行います。（市区町村において条例がある場合は、それに準じます）<br>移動しながらの火葬はいたしません。ご安心ください。</p>
          </div>
        </div>
        <div class="page-s-cremation__card card--4">
          <div class="page-s-cremation__card-img">
  ...
  <section class="page-s-cremation__section page-s-cremation__section--3 section fadein">
    ...
    <div class="page-s-cremation__inner inner">
      ...
      <div class="page-s-cremation__card">
        ...
        <div class="page-s-cremation__card-body">
          <p class="page-s-cremation__card-txt">
            火葬後は、ご希望に応じてお骨上げを行い、ご遺骨を骨壷にお納めしてご返骨いたします。<br>ご自宅でのご供養や、その後のご納骨の相談についても承っております。<br>また、４９日法要や周忌法要も承ります。<br>分骨カプセルやメモリアルグッズなどをご希望の場合は、事前にご案内いたします。
          </p>
      ...
      <div class="page-s-cremation__cards">
        <div class="page-s-cremation__card card--1">
          ...
          <p class="page-s-cremation__card-txt">
            ...
            合同火葬プランは、お骨をお返しできません。火葬後は、一部のお骨を合同墓へお納めいたします。<br>
            生花・祭壇・葬儀自宅葬等は含まれておりません。
          </p>
        </div>
        <div class="page-s-cremation__card card--2">
