  ...
  <main class="page-s-cremation">
    ...
    <section class="page-s-cremation__section page-s-cremation__section--1 section fadein">
      ...
      <div class="page-s-cremation__inner inner">
        ...
        <p class="page-s-cremation__txt">オルデの訪問火葬は、ご自宅またはご自宅近隣まで専用車でお伺いし、火葬のみを執り行うサービスです。葬儀やセレモニーは行わず、「静かに、丁寧に火葬をしてほい」「形式よりも負担を少なくしたい」というご家族様のためのプランです。慣れ親しんだ場所の近くでお見送りができるため、移動のご負担もなく、落ち着いた気持ちで最期の時間をお過ごしいただけます。</p>
      </div>
