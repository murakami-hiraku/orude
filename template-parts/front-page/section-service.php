  ...
  <div class="section-service__inner inner">
    ...
    <div class="section-service__cards">
      ...
      <div class="section-service__card">
        ...
        <p class="section-service__card-txt section-service__card-item">専用設計の火葬炉を備えた専用車でご自宅までお伺いし、ご家族だけで、静かにお見送りができる環境をご用意いたします。<br>慣れ親しんだ場所でゆっくりとお別れの時間を過ごせます。</p>
        ...
        <a href="" class="section-service__link section-service__card-item section-service__link--cremation">サービス詳細へ</a>
      </div>

      <div class="section-service__card">
        <h3 class="section-service__card-ttl section-service__card-item">ご葬儀・セレモニー</h3>
        <p class="section-service__card-txt section-service__card-item">ご家族らしい、かたちにとらわれないお見送りをご提案いたします。<br>想いに寄り添いながらプロデュースいたします。</p>
        ...
        <a href="" class="section-service__link section-service__card-item  section-service__link--ceremony">セレモニーの詳細へ</a>
      </div>
      ...
      <div class="section-service__card">
        ...
        <a href="" class="section-service__link section-service__card-item section-service__link--perpetual-care">永代供養の詳細へ</a>
      </div>
